...
create table "regions" (
  ...
  "id"                          uuid not null,
  "region_world_id"             uuid not null,
  "region_name"                 varchar(255),
  "region_priority"             integer default 0 not null,
  "region_active"               boolean default true not null,
...
create table "region_rules" (
  ...
  "region_id"                   uuid not null,
  constraint "ck_region_rules_status" check ( "status" in ('DENY','ALLOW')),
